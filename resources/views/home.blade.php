...
<div class="container-lg">
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
            <div>
            <div class="fs-4 fw-semibold">${{ $sum }}<span class="fs-6 fw-normal"></div>
            <div>Total Ventas Locales</div>
            </div>
            <div class="dropdown">
            <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <svg class="icon">
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
            <div>
            <div class="fs-4 fw-semibold">${{ $sum_externo }}<span class="fs-6 fw-normal"></div>
            <div>Toatl Ventas externas</div>
            </div>
            <div class="dropdown">
            <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <svg class="icon">
    ...
    <div class="col-sm-6 col-lg-3">
        ...
        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
            <div>
            <div class="fs-4 fw-semibold">${{ ($sum * 918) + $sum_externo }}<span class="fs-6 fw-normal"></div>
            <div>Total Ventas General</div>
            </div>
            <div class="dropdown">
            <button class="btn btn-transparent text-white p-0" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <svg class="icon">
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-4">
            <div class="card text-white bg-success">
                <div class="card-body text-center">
                    <div class="row">
                        <h1 class="text-center">{{ $count_pv }}</h1>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card text-white bg-success">
                <div class="card-body text-center">
                    <div class="row">
                        <h1 class="text-center">{{ $count_pedido }}</h1>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card text-white bg-success">
                <div class="card-body text-center">
                    <div class="row">
                        <h1 class="text-center">{{ $count_pedido + $count_pv }}</h1>
