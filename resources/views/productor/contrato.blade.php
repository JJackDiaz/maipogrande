      ...
      <tbody>
          ...
          <tr>
              ...
              <td>
                ...
                @elseif($contrato->is_active == 'Y' && date('d-m-Y', strtotime($contrato->fecha_termino)) == $date || date('d-m-Y', strtotime($contrato->fecha_firma)) > date('d-m-Y', strtotime($contrato->fecha_termino)) == $date)
